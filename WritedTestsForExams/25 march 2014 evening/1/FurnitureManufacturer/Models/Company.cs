    ...
    public class Company : ICompany
    {
        ...
        public string Name
        {
            ...
            protected set
            {
                ...
                Validator.ValidateIntRange(value.Length, MinNameLenght, MaxNameLenght, string.Format(ErrorMessageForNameLenght, MinNameLenght));
                this.name = value;
            }
        }
